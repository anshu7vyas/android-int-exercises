...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String STORE_QUERY_URL_DATA = "queries";

    // DONE (2) Create a static final key to store the search's raw JSON
    private static final String STORE_SEARCH_RAW_JSON = "results";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            String getSavedQuery = savedInstanceState.getString(STORE_QUERY_URL_DATA);
            mUrlDisplayTextView.setText(getSavedQuery);

            String getJsonSearchResults = savedInstanceState.getString(STORE_SEARCH_RAW_JSON);
            mSearchResultsTextView.setText(getJsonSearchResults);
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(STORE_QUERY_URL_DATA, queryUrl);

        String jsonSearchResults = mSearchResultsTextView.getText().toString();
        outState.putString(STORE_SEARCH_RAW_JSON, jsonSearchResults);
    }
