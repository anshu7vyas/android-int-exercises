...
public class NotificationUtils {
    private static final int WATER_REMINDER_PENDING_INTENT_ID = 7777;
    ...
    private static PendingIntent contentIntent(Context context) {
        ...
        return PendingIntent.getActivity(context, WATER_REMINDER_PENDING_INTENT_ID, openMainActivity, PendingIntent.FLAG_UPDATE_CURRENT);
    }
