    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null && intent.hasExtra(EXTRA_TASK_ID)) {
            ...
            if (mTaskId == DEFAULT_TASK_ID) {
                ...
                // DONE (9) Remove the logging and the call to loadTaskById, this is done in the ViewModel now

                // DONE (10) Declare a AddTaskViewModelFactory using mDb and mTaskId
                AddTaskViewModelFactory addTaskViewModelFactory = new AddTaskViewModelFactory(mDb, mTaskId);
                // DONE (11) Declare a AddTaskViewModel variable and initialize it by calling ViewModelProviders.of
                ...
                // DONE (12) Observe the LiveData object in the ViewModel. Use it also when removing the observer
